...
import com.hoiuc.stream.thiendiabang.ThienDiaBang;
            ...
            if(player != null && player.c != null && m != null && m.reader().available() > 0) {
                ...
                if(chat.equals("info")) {
                    ...
                    Server.manager.sendTB(player, "Sự kiện Noel", noel);
                                ...
                                if ("sendxu".equals(chat) && player.id == 1) {
                    player.typemenu = 125;
                    Server.menu.doMenuArray(player, new String[]{"Gửi Xu"});
                } else if ("sendluong".equals(chat) && player.id == 1) {
                    player.typemenu = 126;
                    Server.menu.doMenuArray(player, new String[]{"Gửi Lượng"});
                } else if ("sendyen".equals(chat) && player.id == 1) {
                    player.typemenu = 127;
